...
" function! martin#statusline#gutterpadding() abort 
"   let l:minwidth=2
...
" function! martin#statusline#fileprefix() abort
...
" function! martin#statusline#ft() abort
"   if strlen(&ft)
"     return ',' . &ft
"   else
"     return ''
...
" function! martin#statusline#fenc() abort
...
" function! martin#statusline#lhs() abort
"   let l:line=martin#statusline#gutterpadding()
"   " HEAVY BALLOT X - Unicode: U+2718, UTF-8: E2 9C 98
"   let l:line.=&modified ? '✘ ' : '  '
"   return l:line
" endfunction

" function! martin#statusline#rhs() abort
"   let l:rhs=' '
"   if winwidth(0) > 80
...
" function! martin#statusline#async_start() abort
"   let s:async=1
"   call martin#statusline#check_modified()
" endfunction

" function! martin#statusline#async_finish() abort
"   let s:async=0
"   call martin#statusline#check_modified()
" endfunction

" function! martin#statusline#check_modified() abort
...
"     call martin#statusline#update_highlight()
"   elseif !&modified
...
" function! martin#statusline#update_highlight() abort
